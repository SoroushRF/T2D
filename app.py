...
class SpreadsheetApp(App):
    ...
    def show_help_screen(self):
        ...
        self.log_widget.write("[bold green]/edit-cell <index> <col_name> <value>[/bold green] (or [bold green]/ec[/bold green])")
        self.log_widget.write("  Edits cell value at row <index> and column <col_name>. Wrap names/values in quotes if they contain spaces.")
        
        self.log_widget.write("[bold green]/clear-cell <index> <col_name>[/bold green] (or [bold green]/cc[/bold green])")
        ...
        self.log_widget.write("[bold green]/help[/bold green] (or [bold green]/h[/bold green] or [bold green]F1[/bold green])")
        self.log_widget.write("  Prints this manual.")
        
        self.log_widget.write("[bold green]/exit[/bold green] (or [bold green]/quit[/bold green] or [bold green]Ctrl+Q[/bold green])")
